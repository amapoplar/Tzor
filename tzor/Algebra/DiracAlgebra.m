...
epslion4::usage = "epslion4 is 4-diemsions Levie-Cita tensor."
...
Format[epslion4[\[Mu]_,\[Nu]_,\[Lambda]_,\[Rho]_],TraditionalForm]:=DisplayForm[SuperscriptBox["\[Epsilon]",RowBox[{\[Mu],\[Nu],\[Lambda],\[Rho]}]]]
...
(*\:65b0\:6307\:6807*)
$tzorcounts = {tzorindex=0}
indexNew[\[Mu]_?StringQ,OptionsPattern["EndQ"-> False]]:= Module[{},
	If[OptionValue["EndQ"],
	tzorindex=tzorindex+1;
	ToExpression[ToString[\[Mu]]<>ToString[tzorindex-1]],
		ToExpression[ToString[\[Mu]]<>ToString[tzorindex]]]];
...
diracalgebra = {gamma[\[Mu]_].gamma[\[Nu]_].gamma[\[Rho]_]:> metric[\[Mu],\[Nu]]gamma[\[Rho]]+metric[\[Nu],\[Rho]]gamma[\[Mu]]-metric[\[Mu],\[Rho]]gamma[\[Nu]]-I epslion4[\[Mu],\[Nu],\[Rho],indexNew["\[Sigma]"]]gamma[indexNew["\[Sigma]","EndQ"->True]].gamma5,
				gamma[\[Mu]_].gamma[\[Mu]_]:> dim,
				gamma5.gamma5->1},
lorezalgebra = {epslion4[___,\[Nu]_,___,\[Nu]_,___]:>0,
metric[\[Mu]_,\[Nu]_]metric[\[Mu]_,\[Lambda]_]:>metric[\[Nu],\[Lambda]],
metric[\[Mu]_,\[Nu]_]^2:>dim,
metric[\[Mu]_,\[Nu]_]epslion4[a___,\[Mu]_,l___]:>epslion4[a,\[Nu],l],metric[\[Mu]_,\[Mu]_]:> dim,
...
algebra  = algebra //.Join[timesalgebra,Dotalgebra,diracalgebra,lorezalgebra,{epslion4[\[Alpha]_,\[Beta]_,\[Gamma]_,\[Delta]_]epslion4[\[Mu]_,\[Nu]_,\[Lambda]_,\[Rho]_]:>-Det[Table[metric[i,j],{j,{\[Alpha],\[Beta],\[Gamma],\[Delta]}},{i,{\[Mu],\[Nu],\[Lambda],\[Rho]}}]]}];
algebra = algebra//.{epslion4[a__,\[Mu]_,c___]gamma[\[Mu]_]:>epslion4[a,gamma,c],
		epslion4[a__,\[Mu]_,c___]gamma[\[Mu]_].gamma5:>epslion4[a,gamma,c]gamma5,
		epslion4[a__,\[Mu]_,c___,\[Nu]_,d___]gamma[\[Mu]_].gamma[\[Nu]_]:>epslion4[a,gamma,c,gamma,d],
		epslion4[a__,\[Mu]_,c___,\[Nu]_,d___]gamma[\[Nu]_].gamma[\[Mu]_]:>- epslion4[a,gamma,c,gamma,d],
		epslion4[w__]:> Signature[Flatten[DeleteDuplicates[Position[Sort[{w}],#]&/@{w}]]]epslion4@@Sort[{w}],
		epslion4[a__,\[Mu]_,c___,\[Nu]_,d___]gamma[\[Mu]_].gamma[\[Nu]_].gamma5:> epslion4[a,gamma,c,gamma,d]gamma5,
		epslion4[a__,\[Mu]_,c___,\[Nu]_,d___]gamma[\[Nu]_].gamma[\[Mu]_].gamma5:>- epslion4[a,gamma,c,gamma,d]gamma5};
...
lorezalgebra = {epslion4[___,\[Nu]_,___,\[Nu]_,___]:>0,
			metric[\[Mu]_,\[Nu]_]metric[\[Mu]_,\[Lambda]_]:>metric[\[Nu],\[Lambda]],
			metric[\[Mu]_,\[Nu]_]^2:>dim,metric[\[Mu]_,\[Nu]_]epslion4[a___,\[Mu]_,l___]:>epslion4[a,\[Nu],l],
...
alge = repacleGamma5[alge]//.Join[{gamma5-> -(1/4!)epslion4[indexNew["eps1"],indexNew["eps2"],indexNew["eps3"],indexNew["eps4"]].gamma[indexNew["eps1"]].gamma[indexNew["eps2"]].gamma[indexNew["eps3"]].gamma[indexNew["eps4","EndQ"->True]]},
Dotalgebra];
(trackContractMaster[alge]//Expand) //.Join[lorezalgebra ,{
			epslion4[a__,\[Mu]_,c___]gamma[\[Mu]_]:>epslion4[a,gamma,c],
			epslion4[a__,\[Mu]_,c___]gamma[\[Mu]_].gamma5:>epslion4[a,gamma,c]gamma5,
			epslion4[a__,\[Mu]_,c___,\[Nu]_,d___]gamma[\[Mu]_].gamma[\[Nu]_]:>epslion4[a,gamma,c,gamma,d],
			epslion4[a__,\[Mu]_,c___,\[Nu]_,d___]gamma[\[Nu]_].gamma[\[Mu]_]:>- epslion4[a,gamma,c,gamma,d],
			epslion4[w__]:> Signature[Flatten[DeleteDuplicates[Position[Sort[{w}],#]&/@{w}]]]epslion4@@Sort[{w}],
